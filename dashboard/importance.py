...
- Średni błąd kwadratowy dla średniej oceny: {mse_avg:.4f}
- Średni błąd kwadratowy dla odchylenia standardowego ocen: {mse_std:.4f}
""")

st.text("Ważność cech w modelu regresji liniowej dla średniej ocen.")
...
st.text("Ważność cech w modelu regresji liniowej dla odchylenia standardowego ocen.")
...
st.text("Ważność cech w modelu Gradient Boosting dla średniej oceny.")
...
st.text("Ważność cech w modelu Gradient Boosting dla odchylenia standardowego ocen.")
